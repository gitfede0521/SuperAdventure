...
namespace Engine
{
    public static class World
    {
        ...
        public const int MONSTER_ID_GIANTS_SPIDER = 3;
        ...
        private static void PopulateMonsters()
        {
            ...
            Monster giantspider = new Monster(MONSTER_ID_GIANTS_SPIDER, "Giant spider", 20, 5, 40, 10, 10);
        ...
        {
            Quest clearAlchemistGarden = new Quest(QUEST_ID_CLEAR_ALCHEMISTS_GARDEN,
            ...
            Quest clearFarmersField = new Quest(QUEST_ID_CLEAR_FARMERS_FIELD,
                ...
                "Kill snakes in the farmer's field and bring nack 3 snake fangs." +
        ...
        private static void PopulateLocations()
        {
            ...
            Location alchemistHut = new Location(LOCATION_ID_ALCHEMISTS_HUT,
            ...
            Location alchemistsHut = new Location(LOCATION_ID_ALCHEMISTS_HUT,
                "Alchemist's hut", "There are many strange plants on the shelves.");
            alchemistHut.QuestAvailableHere = QuestByID(QUEST_ID_CLEAR_ALCHEMISTS_GARDEN);        
            ...
            spiderField.MonsterLivingHere = MonsterByID(MONSTER_ID_GIANTS_SPIDER);
